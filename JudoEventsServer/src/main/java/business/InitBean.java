...
public class InitBean {
    ...
    private void init(){
        ...
        eventFacade.create(new Event(LocalDate.of(2016, 1, 1),LocalDate.of(2016, 1, 11), TypeOfEvent.Trainingscamp,"OTC Nymbuk 2016","Olympic Trainings Camp",35.50,"","U18 and Above","http://lorempixel.com/400/300/sports/",clubFacade.findById(4).getLocation(),clubFacade.findById(4),clubFacade.findById(4).getRepresentative()));
        ...
        eventFacade.create(new Event(LocalDate.of(2018, 2, 12),LocalDate.of(2018, 2, 13), TypeOfEvent.Turnament,"International Turnament Rohrbach","IT Rohrbach",10.50,"Medals","M-60;M-66;M-73;M-81;M-90;M-100;M+100;","http://lorempixel.com/400/300/sports/",clubFacade.findById(1).getLocation(),clubFacade.findById(1),clubFacade.findById(1).getRepresentative()));
